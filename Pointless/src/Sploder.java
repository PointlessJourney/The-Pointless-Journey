...
public class Sploder extends EBullet{
	...
	public void tick(){
		...
		super.tick();
		if(delay<=0){
			for(int i = 0;i<2000;i++)Handler.addEBullet(new EBullet(x,y,ID.Bullet,LoadImage("Boss1-1.png"),0.3/1360.0*MainMenu.width,(Math.random()*Math.PI*2),(1000+(Math.random()*7000))/1360.0*MainMenu.width,1,10000000));
